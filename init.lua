...
vim.wo.signcolumn = 'yes' -- Show the sign column to display signs such as "+", "-", or ":".
...
vim.keymap.set('n', '<leader>tf', ':ToggleTerm direction=float<CR>', { desc = 'toggles floating terminal' })
