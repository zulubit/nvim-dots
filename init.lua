...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'php', 'lua', 'markdown', 'vim', 'vimdoc' },
  ...
  -- MY CUSTOM PLUGINS
  {
    ...
    vim.api.nvim_set_keymap('n', '<space>ee', ':Telescope file_browser<CR><esc>', { noremap = true }),
    vim.api.nvim_set_keymap('n', '<space>ec', ':Telescope file_browser path=%:p:h select_buffer=true<CR><esc>', { noremap = true }),
  },
...
vim.keymap.set('n', '<leader>bo', '<Cmd>BufferCloseAllButCurrentOrPinned<CR>', { desc = 'Close all non pinned or opened buffers' })
